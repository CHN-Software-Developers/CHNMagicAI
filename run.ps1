# AIVideoBuilder launcher (PowerShell). First run installs everything automatically.
...
Write-Host "=== AIVideoBuilder: first-run setup check ===" -ForegroundColor Cyan
...
Write-Host "=== Launching AIVideoBuilder ===" -ForegroundColor Cyan
